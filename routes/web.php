...
Route::get('/statistics/points', "StatisticsController@points"); // prikazuje detaljnije statistiku za poene npr. sa vise igraca
Route::get('/statistics/rebounds', "StatisticsController@rebounds"); // isto kao iznad
// ...
