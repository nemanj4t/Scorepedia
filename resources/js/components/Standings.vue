...
<script>
    export default {
        ...
        methods: {
            ...
            show(category) {
                if (category === this.stands.sort) {
                    this.stands.dir = this.stands.dir === 'asc' ? 'desc' : 'asc';
                    this.stands.array = this.stands.array.reverse();
                }
                else {
                    this.stands.sort = category;
                    this.stands.dir = this.stands.dir === 'asc' ? 'desc' : 'asc';
                    axios.get('/standings/' + category)
                        .then(response => {

                            this.stands.array = response.data;
        ...
        mounted() {
            ...
            axios.get('/standings/points')
                .then(response => {
                   this.stands.array = response.data;
                   this.stands.sort = 'points';
                   this.stands.dir = 'desc';
