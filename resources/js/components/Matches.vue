<template>
     ...
     <div>
        ...
        <div class="container card mt-4 mb-4" v-if="liveMatches.length > 0">
            <div class="card-body">
                <h3>Live</h3>
                <div class="row justify-content-between" v-for="match in liveMatches">
        ...
        <div class="container card mt-4 mb-4" v-if="upcomingMatches.length > 0">
            <div class="card-body">
                <h3>Upcoming</h3>
                <div class="row justify-content-between" v-for="match in upcomingMatches">
        ...
        <div class="container card mt-4 mb-4" v-if="finishedMatches.length > 0">
            <div class="card-body">
                <h3>Finished</h3>
                <div class="row justify-content-between" v-for="match in finishedMatches">
                        <div class="col-md-5 m-4" style="border: dashed 1px; padding: 20px">
                            <div class="row">
                                <div class="col-md-4">
                                    <img style="max-width: 100%;" v-bind:src="match.team_match.home.image">
